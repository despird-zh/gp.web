var PageContext = (function ($, AdminLTE) {
	...
	var StorageList = {
		...
		// new storage button
		$new_storage_btn : $('a[gpid="new-storage-btn"]'),
		...
		initial : function(){
			...
			// bind new storage button
			_self.$new_storage_btn.bind('click', function(){
				StorageNew.clear();
	...
	var StorageNew = {
		...
		$close_btn : $('#tab_3 button[gpid="new-close-btn"]'),
		
		initial : function(){
			var _self = this;
			
			_self.$save_btn.bind('click', function(){
				StorageNew.saveStorage();
			});
