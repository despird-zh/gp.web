...
<html lang="zh_CN">
  ...
  <body class="hold-transition skin-blue fixed layout-top-nav">
			...
			<div class="row ">
				<div class="col-sm-12">		
					...
					<ul class="nav nav-tabs navibar-page pull-right" style="position: absolute; right: 15px; top: 0px; margin-bottom: 0px; border-bottom-width: 1px; margin-top: 6px;">
						<li class="active"><a aria-expanded="false" href="workgroup-grid.do"><i class="fa fa-fw fa-cubes"></i></a></li>
						<li class=""><a aria-expanded="true" href="netdisk-pub.do"><i class="fa fa-fw fa-database"></i></a></li>    
						...
						<li class="pull-right"><a href="../workgroup/workgroup-list.do" class="text-muted"><i class="fa fa-th-list"></i></a></li>
						<li class="pull-right"><a href="../workgroup/workgroup-grid.do" class="text-primary"><i class="fa fa-th"></i></a></li>
					</ul>
	...
	<!-- GPress Page scripts -->
	<script src="${path_script}/pages/workgroups-grid.js"></script>
  </body>
</html>
