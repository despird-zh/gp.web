			...
			<div class="row ">
				<div class="col-sm-12">	
					...
					<ul class="nav nav-tabs navibar-page pull-right" style="position: absolute; right: 15px; top: 0px; margin-bottom: 0px; border-bottom-width: 1px; margin-top: 6px;">
						...
						<li class="active" data-toggle="tooltip" title="netdisk"><a  href="netdisk.do" aria-expanded="true"><i class="fa fa-fw fa-database"></i></a></li>    
						...
						<li class="pull-right active" data-toggle="tooltip" title="Public disk"><a class="text-primary" href="../workgroup/workgroup-list.do"><i class="fa fa-sun-o"></i></a></li>
						<li class="pull-right" data-toggle="tooltip" title="private disk"><a class="text-muted" href="../workgroup/workgroup-grid.do"><i class="fa fa-moon-o"></i></a></li>
					</ul>
