        ...
        <div class="container">
          <section class="content-header">
			...
			<ul class="nav nav-tabs navibar-page pull-right" style="position: absolute; right: 10px; top: 15px;">
				<li class="active"><a  href="workgroup-grid.do" aria-expanded="false"><i class="fa fa-fw fa-cubes"></i></a></li>
				...
				<li class="pull-right"><a class="text-primary" href="../workgroup/workgroup-grid.do"><i class="fa fa-th"></i></a></li>
			</ul>
          </section>
