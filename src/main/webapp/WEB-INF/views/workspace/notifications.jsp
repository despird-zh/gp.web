				...
				<div class="row ">
					<div class="col-sm-12">	
						...
						<ul class="nav nav-tabs navibar-page pull-right" style="position: absolute; right: 15px; top: 0px; margin-bottom: 0px; border-bottom-width: 1px; margin-top: 6px;">
							...
							<li><a class="bg-aqua-active" data-toggle="tooltip" title="查看个人通知消息" href="notifications.do?user_id=${wgroup_id}" aria-expanded="false"><i class="fa fa-fw fa-commenting"></i></a></li>
						</ul>
