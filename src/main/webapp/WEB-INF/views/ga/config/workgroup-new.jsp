			 ...
			 <!-- Custom Tabs -->
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
					...
					<li class="hidden" gpid="member-tab" ><a data-toggle="tab" href="#tab_3">成员用户</a></li>
					<li class="hidden" gpid="member-group-tab" ><a data-toggle="tab" href="#tab_1">成员用户组</a></li>    
					<li class="pull-right">
						<button gpid="member-mgmt-btn" class="text-primary btn btn-sm btn-default" >
							<i class="fa fa-fw fa-user"></i>
						</button>
					</li>
					<li class="pull-right">
						<button gpid="group-mgmt-btn" class="text-primary btn btn-sm btn-default" >
				...
				<div id="tab_3" class="tab-pane">
				  ...
				  <div class="box-footer">
					<button gpid="member-close-btn" type="button" class="btn btn-default" >Close</button>
				  </div><!-- /.box-footer -->
				</div><!-- /.tab-pane -->
				...
				<div class="box-footer">
					<button gpid="group-close-btn" type="button" class="btn btn-default" >Close</button>
				</div><!-- /.box-footer -->
				</div><!-- /.tab-pane -->
                </div><!-- /.tab-content -->
              </div><!-- nav-tabs-custom -->
